            ...
            <div className="min-h-screen pb-20">
                ...
                <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
                    ...
                    <div className="flex gap-2">
                        <Link to='/app?state=register' className="hidden md:block px-6 py-2 bg-yellow-500 hover:bg-yellow-700 active:scale-95 transition-all rounded-full text-white">
                            Get started
                        </Link>
                        <Link to='/app/login' className="hidden md:block px-6 py-2 border active:scale-95 hover:bg-slate-50 transition-all rounded-full text-slate-700 hover:text-slate-900" >
                            Login
                        </Link>
                    </div>
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
                        “To win her heart, get a job —  😄 <span className=" bg-gradient-to-r from-yellow-700 to-yellow-600 bg-clip-text text-transparent text-nowrap">AI-powered </span> resumes help land dream jobs.”
                    </h1>

                    <p className="max-w-md text-center text-base my-7">“Need a job to impress girlfriend.
Using AI power to get dream job.
Because love + AI = guaranteed motivation.” 🤖❤️ </p>
